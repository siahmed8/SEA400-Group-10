...
def highestGPA(semGradeList, astudent):
    ...
    ## TODO "*** YOUR CODE HERE ***"
    bestSem = None
    highestGPA = float('-inf')
    for sem in semGradeList:
        semGPA = astudent.getGPA(sem)
...
if __name__ == '__main__':
    ...
    print("GPA for semester 1 for", std.getName(), "is", std.getGPA(semester1))
    print("GPA for semester 2 for", std.getName(), "is", std.getGPA(semester2))
